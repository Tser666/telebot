...
2. 按 SemVer 判断版本级别：
   ...
   - `MINOR`：用户可感知的新能力、主入口重组、新模块或重要工作流变化。
...
适用：远程模块、内置模块、插件安装/更新/启停、沙箱 facade、AI/HTTP 权限、worker 热加载相关问题。
...
适用：前端页面、工作台布局、模块中心、AI 设置、日志中心、配置表单、移动端/PWA 相关变更。
